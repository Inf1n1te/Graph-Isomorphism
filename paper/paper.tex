...
\end{tabular}
\caption{Table showing the result of the experiment. For each graph, it shows the computation time without and with preprocessing time, as well as the time it took to perform the preprocessing.}
\label{table:results}
\end{table}
\end{appendices}
