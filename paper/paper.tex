...
Define a module $M_i \subseteq V_{G1}: \{v \in V_{G1}$ $|$ corresponding vertex in $H_1$ has color $i \}$. $\forall a, b \in V_{G1}$ such that $a,b \in M_i$ for some $i$: $\{a,b\} \in E_{G1} \iff \{c,d\} \in E_{H1}$. $c,d$ are the corresponding vertices of resp. $a,b$. $\{c,d\} \in E_{H1} \iff \{h(c),(d)\} \in E_{H2} \iff $
